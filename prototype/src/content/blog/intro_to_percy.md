...
![Visual changes](/assets/images/percy_intro/cover.png)
...
![Super Rentals](/assets/images/percy_intro/1-super_rentals.png)

On the Home page you can find a button that take us to the About page:

![Home page](/assets/images/percy_intro/2-home.png)

And on the About page we have a button to go back to the Home page:

![About page](/assets/images/percy_intro/3-about.png)
...
![I have no idea](/assets/images/percy_intro/4-no_idea.jpeg)
...
![New color on about page](/assets/images/percy_intro/5-new_color.png)

You run **all** your tests and they pass.

![Tests pass](/assets/images/percy_intro/6-tests_pass.png)

Good to go to production!

![Yes!](/assets/images/percy_intro/7-yes.jpeg)
...
![A bug](/assets/images/percy_intro/8-bug.png)

Yes, you have introduced a bug in the system.

![Bug meme](/assets/images/percy_intro/9-bug_meme.jpeg)

![Shame meme](/assets/images/percy_intro/10-shame.jpeg)
...
![Percy](/assets/images/percy_intro/11-percy.png)
...
![Percy running](/assets/images/percy_intro/12-percy_running.png)
![Percy running](/assets/images/percy_intro/13-percy_running.png)
...
![Percy build 1](/assets/images/percy_intro/14-percy_build1.png)
...
![Percy build 2](/assets/images/percy_intro/15-percy_build2.png)

We can see that the first diff is something we expected. So we can approve it.

![Percy build 2 - diff 1](/assets/images/percy_intro/16-percy_build2-diff1.png)

The second change is the bug! We will click on _Request changes_ in order to mark this build as incomplete.

![Percy build 2 - diff 2](/assets/images/percy_intro/16-percy_build2-diff2.png)
...
![Percy build 3](/assets/images/percy_intro/17-percy_build3.png)

Now we can merge our changes to _master_ and Percy will auto-approve the build.

![Percy build 4](/assets/images/percy_intro/18-percy_build4.png)
